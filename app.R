        ...
        tabItems(
            ...
            tabItem(
                ...
                tabBox(width = 12,
                    ...
                    tabPanel(
                        "Como fazer?",
                        p("O primeiro passo é calcular a estatística de teste (Z). Esse valor mede a discrepância entre o que foi observado na amostra e o que seria esperado caso a hipótese nula fosse verdadeira. Nesse caso, ela é calculada assim:"),
                        withMathJax(helpText('$$Z\\ =\\ \\frac{\\bar{x}\\ -\\ \\theta}{\\sigma/\\sqrt{n}}$$')),
                        withMathJax(helpText('$$\\bar{x}\\ =\\ média\\ amostral$$')),
                        withMathJax(helpText('$$\\sigma\\ =\\ variância\\ populacional$$')),
            ...
            tabItem(
                ...
                tabBox(width = 12,
                    tabPanel(
                        ...
                        withMathJax(helpText('$$H_{0}:\\ \\mu_{1}\\ =\\ \\mu_{2}$$')),
                        withMathJax(helpText('$$H_{1}:\\ \\mu_{1}\\ \\neq\\ \\mu_{2}$$')),
                        p("ou", align = "center"),
                        withMathJax(helpText('$$H_{0}:\\ \\mu_{1}\\ \\leqslant\\ \\mu_{2}$$')),
                        withMathJax(helpText('$$H_{1}:\\ \\mu_{1}\\ >\\ \\mu_{2}$$')),
                        p("ou", align = "center"),
                        withMathJax(helpText('$$H_{0}:\\ \\mu_{1}\\ \\geqslant\\ \\mu_{2}$$')),
                        withMathJax(helpText('$$H_{1}:\\ \\mu_{1}\\ <\\ \\mu_{2}$$'))
                    ),
                    tabPanel(
                        "Como fazer?",
